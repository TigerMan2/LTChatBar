...
#import "LTChatEmojiBottomView.h"
...
@interface LTChatEmojiView () <UIScrollViewDelegate,LTChatEmojiBottomViewDelegate>
...
@implementation LTChatEmojiView
{
    ...
    LTChatEmojiBottomView *_bottomView;
}
...
- (void)didInitialize {
    ...
    _bottomView = [[LTChatEmojiBottomView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_scrollView.frame), self.frame.size.width, kChatEmojiBottomToolBarHeight)];
...
- (void)emojiPageViewEmojiSelected:(NSNotification *)noti {
    ...
    LTChatEmojiThemeStyle themeStyle = [[info objectForKey:EmojiPageViewEmojiThemeStyle] integerValue];
...
- (void)loadEmojiThemeItems:(NSArray <LTChatEmojiThemeModel *> *)themeItems {
    ...
    for (int i = 0; i < themeItems.count; i ++) {
        LTChatEmojiThemeView *view = [[LTChatEmojiThemeView alloc] initWithFrame:CGRectMake(i * CGRectGetWidth(_scrollView.frame), 0, CGRectGetWidth(_scrollView.frame), CGRectGetHeight(_scrollView.frame))];
...
#pragma mark - LTChatEmojiBottomViewDelegate
